...
create table APP_CHAT_QNA(
    ...
    s_id NUMBER(20,0) NOT NULL REFERENCES APP_CHAT_SESSION(id),
    q_id NUMBER(20,0) NOT NULL REFERENCES APP_CHAT_QUESTION(id),
    a_id NUMBER(20,0) NOT NULL REFERENCES APP_CHAT_ANSWER(id),
